...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { starts_at: @meeting.starts_at, title: @meeting.title } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { starts_at: @meeting.starts_at, title: @meeting.title } }
